Rails.application.routes.draw do
  ...
  post("/modify_director/:the_id", { :controller => "directors", :action => "modify" })

  get("/movies", { :controller => "movies", :action => "index" })
  get("/movies/:path_id", { :controller => "movies", :action => "show" })
  post("/insert_movie", { :controller => "movies", :action => "create" })
  get("/delete_movie/:an_id", { :controller => "movies", :action => "destroy" })
  post("/modify_movie/:the_id", { :controller => "movies", :action => "modify" })
  ...
  post("/modify_actor/:the_id", { :controller => "actors", :action => "modify" })
end
